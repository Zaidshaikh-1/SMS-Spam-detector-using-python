...
from model_updated import train_model
from sms_spam_detector import predict
...
def classify_message():
    ...
    # Use threshold parameter in predict
    prediction, confidence = predict(model, vectorizer, user_message, threshold=0.6)
